...
const translations = {
  es: {
    ...
    formats_magic: 'Formatos: cantidad nombre / cantidad nombre (SET) / cantidad nombre (SET-nº) / cantidad,"nombre",SET / cantidad,"nombre",SET,nº',
    ...
    help_magic_section_title: 'Magic: The Gathering Collage',
    help_magic_section_link: 'Ayuda de Magic: The Gathering Collage',
    help_pokemon_section_title: 'Pokémon TCG Collage',
    help_pokemon_section_link: 'Ayuda de Pokémon TCG Collage',
  ...
  en: {
    ...
    formats_magic: 'Formats: quantity name / quantity name (SET) / quantity name (SET-num) / quantity,"name",SET / quantity,"name",SET,num',
    ...
    help_magic_section_title: 'Magic: The Gathering Collage',
    help_magic_section_link: 'Help with Magic: The Gathering Collage',
    help_pokemon_section_title: 'Pokémon TCG Collage',
    help_pokemon_section_link: 'Help with Pokémon TCG Collage',
